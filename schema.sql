-- Drop existing tables if they exist to allow clean script re-run
...
-- Drop existing custom enum types if they exist
...
-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('DRAFT', 'CONFIRMED', 'SHIPPED', 'RECEIVED', 'FULFILLED', 'CANCELLED');
